...
//		utils.Responser.Fail(ctx, utils.OptionFailur)
//		log.Print("数据接收失败")
//		return
//	}
//	e := global.GVA_DB
...
//		return
//	}
//	utils.Responser.OkWithDetails(ctx, resultcode.Success, job)
//}
//
...
//		return
//	}
//	utils.Responser.OkWithDetails(ctx, resultcode.Success, userModel.GetUserAbstractResList(users))
//}
//
